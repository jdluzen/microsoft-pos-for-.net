namespace Microsoft.PointOfService
{
    public abstract class Cat : Microsoft.PointOfService.PosCommon
    {
        ...
        public abstract System.Boolean CapAdditionalSecurityInformation { get; }
        public abstract System.Boolean CapAuthorizeCompletion { get; }
        public abstract System.Boolean CapAuthorizePreSales { get; }
        public abstract System.Boolean CapAuthorizeRefund { get; }
        public abstract System.Boolean CapAuthorizeVoid { get; }
        public abstract System.Boolean CapAuthorizeVoidPreSales { get; }
        public abstract System.Boolean CapCenterResultCode { get; }
        public abstract System.Boolean CapCheckCard { get; }
        public abstract Microsoft.PointOfService.CatLogs CapDailyLog { get; }
        public abstract System.Boolean CapInstallments { get; }
        public abstract System.Boolean CapPaymentDetail { get; }
        public abstract System.Boolean CapTaxOthers { get; }
        public abstract System.Boolean CapTransactionNumber { get; }
        ...
        public abstract System.String ApprovalCode { get; }
        public abstract System.Boolean AsyncMode { get; set;  }
        public abstract System.String CardCompanyId { get; }
        public abstract System.String CenterResultCode { get; }
        public abstract System.String DailyLog { get; }
        public abstract Microsoft.PointOfService.PaymentCondition PaymentCondition { get; }
        public abstract System.String PaymentDetail { get; }
        public abstract Microsoft.PointOfService.PaymentMedia PaymentMedia { get; set;  }
        public abstract System.Int32 SequenceNumber { get; }
        public abstract System.String SlipNumber { get; }
        public abstract System.Boolean TrainingMode { get; set;  }
        public abstract System.String TransactionNumber { get; }
        public abstract Microsoft.PointOfService.CreditTransactionType TransactionType { get; }
        public virtual System.Decimal Balance { get { return new System.Decimal(); } }
        public virtual System.Boolean CapCashDeposit { get { return false; } }
        public virtual System.Boolean CapLockTerminal { get { return false; } }
        public virtual System.Boolean CapLogStatus { get { return false; } }
        public virtual System.Boolean CapUnlockTerminal { get { return false; } }
        public virtual Microsoft.PointOfService.DealingLogStatus LogStatus { get { return Microsoft.PointOfService.DealingLogStatus.Ok; } }
        public virtual System.Decimal SettledAmount { get { return new System.Decimal(); } }
